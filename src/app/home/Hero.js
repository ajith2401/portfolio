        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                href="#contact" 
                className="glass-container inline-flex items-center gap-2 px-6 py-3 rounded-lg text-foreground hover:-translate-y-1 transition-all"
              >
                Get in Touch
              ...
              <div className="flex gap-4">
                <a 
                  ...
                  className="glass-container p-3 rounded-lg hover:-translate-y-1 transition-all"
                >
